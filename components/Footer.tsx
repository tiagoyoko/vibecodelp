            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" data-oid="859n7vl">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8" data-oid="17tuzmk">
                    ...
                    <div className="col-span-1 md:col-span-2" data-oid="5e_d6gj">
                        ...
                        <div className="flex space-x-4 mt-6" data-oid="3whs.43">
                            <a
                                href="#"
                    ...
                    {/* Quick Links */}
                    <div data-oid="1n3oc6n">
                        <h3 className="text-white font-semibold mb-4" data-oid="_2d4tmy">
                            Links Rápidos
                        </h3>
                        <ul className="space-y-2" data-oid="v4:.h0z">
                            <li data-oid="smvfz6l">
                                <a
                                    href="#home"
                    ...
                    {/* Support */}
                    <div data-oid="tn8bfxi">
                        <h3 className="text-white font-semibold mb-4" data-oid="ynk5k-c">
                            Suporte
                        </h3>
                        <ul className="space-y-2" data-oid="ahscn:1">
                            <li data-oid="g6gd3co">
                                <a
                                    href="#contact"
                                    className="text-gray-400 hover:text-white transition-colors text-sm"
